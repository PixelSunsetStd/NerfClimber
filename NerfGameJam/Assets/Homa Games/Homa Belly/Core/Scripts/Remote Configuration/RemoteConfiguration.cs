// Comment below line if Remote Configuration needs to be awaited
#define NOT_AWAIT_REMOTE_CONFIGURATION
...
#pragma warning restore CS1998 // El método asincrónico carece de operadores "await" y se ejecutará de forma sincrónica
        {
            ...
            try
            {
                ...
                {
                    string firstTimeUri = string.Format(RemoteConfigurationConstants.API_FIRST_TIME_URL, trackingData["ti"], Application.identifier, GetUserAgent());
                    ...
                    string everyTimeUri = string.Format(RemoteConfigurationConstants.API_EVERY_TIME_URL, trackingData["ti"], Application.identifier, GetUserAgent(), trackingDataString);
...
#if NOT_AWAIT_REMOTE_CONFIGURATION
